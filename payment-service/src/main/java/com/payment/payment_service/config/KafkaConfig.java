...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, PaymentEvent> producerFactory(ObjectMapper objectMapper) {

        Serializer<PaymentEvent> valueSerializer = (topic, data) -> {
            try {
                return objectMapper.writeValueAsBytes(data);
            } catch (Exception e) {
                throw new RuntimeException("Erreur sérialisation PaymentEvent", e);
            }
        };
